...
<div class="col-sm-12">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h5>
                <button type="button" onclick="window.location.href='{{ route('admin.roll.add') }}'"
                        class="btn btn-w-m btn-primary">添加轮播图
                </button>
            </h5>
        </div>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="javascript:void(0);"
                                               onclick="removeCate(this,'{{ route('admin.roll.delete',['roll_id'=>$value->id]) }}')">删除</a>
                                        </li>
                                    </ul>
                                </div>
                            </td>
