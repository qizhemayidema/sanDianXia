    ...
    <div class="ibox-content">
        <form action="" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="name" required placeholder="例如:李先生" type="text" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" placeholder="详细地址" style="margin-top: 18px;" name="address" class="form-control">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" name="msg_price" placeholder="元" required class="form-control">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="validity_time" class="form-control layer-date"
