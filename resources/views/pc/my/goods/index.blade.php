...
@section('title') 我的产品 @endsection

@section('content')
    <div class="my_b_r_type my_b_r_type1">
        <span class="">我的产品</span>
    </div>
    <div class="w100">
        @if(!$data)
            ...
            <div id="collect_list_box">
                ...
                <div class="js_list oh bb1 abb_list">
                    ...
                    <div class="js_info oh">
                        ...
                        <div class="js_btn">
                            <button class="blue_btn" type="button" onclick="location.href='{{ route('pc.my.goods.edit') }}?goods_id='+{{ $value->id }}">编辑</button>
