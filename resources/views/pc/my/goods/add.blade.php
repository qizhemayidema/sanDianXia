...
@section('content')
    <form action="">
        {{ csrf_field() }}
    <input type="hidden" name="roll_pic">
    <!-- 我的发布 -->
        ...
        <div style="margin-top: 20px;">
            <div class="add_list oh mb20">
                ...
                <div class="add_kuang fl">
                    <input type="text" name="title" class="fz16 c3 lh40">
                </div>
            </div>
            <div class="add_list oh mb20">
            ...
            <div class="add_list oh mb20">
                ...
                <div class="add_kuang fl oh" style="width: 746px;height: 110px;border-radius: 5px;">
                    <textarea name="sku_desc" id="" rows="5"></textarea>
                </div>
            </div>
            <div class="add_list oh mb20">
            ...
            <div class="add_list oh mb20">
                ...
                <div class="addBtn tal">
                    <button type="button" onclick="save()">发布</button>
                </div>
            </div>
        </div>
    </div>
